...
mod integration_tests {
    ...
    use crate::typecheck::{
        TypeChecker, ModuleInterner, StrategyBuilder,
        TypeCheckError, BuiltinTypes
    };
    ...
    fn test_enum_type_checking() {
        ...
        // Should succeed
        assert!(result.is_ok(), "Enum type checking failed: {:?}", result.err());
    ...
    fn test_dependent_type_checking() {
        ...
        // Should succeed
        assert!(result.is_ok(), "Dependent type checking failed: {:?}", result.err());
    ...
    fn test_undefined_type_error() {
        ...
        assert!(result.is_err(), "Expected type checking to fail for undefined type");
    ...
    fn test_strategy_builder_integration() {
        ...
        assert!(strategy_result.is_ok(), "Strategy building failed: {:?}", strategy_result.err());
        ...
        assert!(result.is_ok(), "Full type checking failed: {:?}", result.err());
    }
    ...
    fn test_unsupported_type_expression_error() {
        ...
        assert!(result.is_err(), "Expected type checking to fail for unsupported type expression");
